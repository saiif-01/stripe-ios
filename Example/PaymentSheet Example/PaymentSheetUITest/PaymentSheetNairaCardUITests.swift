//
//  PaymentSheetNairaCardUITests.swift
//  PaymentSheetUITest
//
...
class PaymentSheetNairaCardUITests: PaymentSheetStandardLPMUICase {
    ...
    private func confirm(mode: PaymentSheetTestPlaygroundSettings.Mode) {
        // Given a NairaCard checkout with the supported intent mode
        ...
        settings.supportedPaymentMethods = "ng_card"
        settings.mode = mode
