//
//  PaymentSheetTouchNGoUITests.swift
//  PaymentSheetUITest
//
...
class PaymentSheetTouchNGoUITests: PaymentSheetStandardLPMUICase {
    ...
    private func confirm(mode: PaymentSheetTestPlaygroundSettings.Mode) {
        // Given a TouchNGo checkout with the supported intent mode
        ...
        settings.supportedPaymentMethods = "touch_n_go"
        settings.mode = mode
