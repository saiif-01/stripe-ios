//
//  PaymentSheetTrueMoneyUITests.swift
//  PaymentSheetUITest
//
...
class PaymentSheetTrueMoneyUITests: PaymentSheetStandardLPMUICase {
    ...
    private func confirm(mode: PaymentSheetTestPlaygroundSettings.Mode) {
        // Given a TrueMoney checkout with the supported intent mode
