//
//  PaymentSheetShopeePayUITests.swift
//  PaymentSheetUITest
//
...
class PaymentSheetShopeePayUITests: PaymentSheetStandardLPMUICase {
    func testPaymentIntent() {
        // Given a ShopeePay payment
        ...
        settings.supportedPaymentMethods = "shopeepay"
