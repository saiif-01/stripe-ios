//
//  PaymentSheetGoPayUITests.swift
//  PaymentSheetUITest
//
...
class PaymentSheetGoPayUITests: PaymentSheetStandardLPMUICase {
    ...
    private func confirm(mode: PaymentSheetTestPlaygroundSettings.Mode) {
        // Given a GoPay checkout with the supported intent mode
        ...
        settings.supportedPaymentMethods = "gopay"
        settings.mode = mode
