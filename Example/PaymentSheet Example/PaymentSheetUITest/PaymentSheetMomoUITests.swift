...
class PaymentSheetMomoUITests: PaymentSheetStandardLPMUICase {
    ...
    private func confirm(mode: PaymentSheetTestPlaygroundSettings.Mode) {
        // Given a Momo checkout with the supported intent mode
        ...
        settings.supportedPaymentMethods = "momo"
        settings.mode = mode
