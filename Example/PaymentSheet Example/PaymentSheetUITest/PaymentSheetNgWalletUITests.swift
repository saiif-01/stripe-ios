//
//  PaymentSheetNgWalletUITests.swift
//  PaymentSheetUITest
//
...
class PaymentSheetNgWalletUITests: PaymentSheetStandardLPMUICase {
    func testPaymentIntent() {
        // Given a Naira Wallet payment
        ...
        settings.supportedPaymentMethods = "ng_wallet"
