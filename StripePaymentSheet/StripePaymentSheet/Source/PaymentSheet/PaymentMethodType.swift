        ...
        static func supportsAdding(
            ...
            if intent.isSetupFutureUsageSet(for: paymentMethod) {
                requirements = {
                    ...
                    case .bacsDebit:
                        return [.returnURL, .userSupportsDelayedPaymentMethods]
                    case .ngBankTransfer, .shopeePay, .cardPresent, .blik, .weChatPay, .grabPay, .FPX, .przelewy24, .EPS,
                ...
                requirements = {
                    ...
                    case .blik, .card, .cardPresent, .weChatPay, .paynow, .promptPay, .mbWay, .bizum:
                        return []
                    case .ngCard, .ngBankTransfer, .momo, .gcash, .touchNGo, .trueMoney, .shopeePay, .goPay, .alipay, .EPS, .FPX, .grabPay, .netBanking, .payPal, .przelewy24, .klarna,
