        ...
        static func supportsAdding(
            ...
            if intent.isSetupFutureUsageSet(for: paymentMethod) {
                requirements = {
                    ...
                    case .card:
                        return []
                    case .ngCard, .momo, .gcash, .touchNGo, .trueMoney, .goPay, .alipay, .payPal, .cashApp, .revolutPay, .amazonPay, .klarna, .satispay, .twint, .kakaoPay, .naverPay, .krCard:
                        return [.returnURL]
                    ...
                    case .bacsDebit:
                        return [.returnURL, .userSupportsDelayedPaymentMethods]
                    case .ngBankTransfer, .shopeePay, .ngWallet, .qris, .ngUSSD, .mondu, .cardPresent, .blik, .weChatPay, .grabPay, .FPX, .przelewy24, .EPS,
                ...
                requirements = {
                    ...
                    case .blik, .card, .cardPresent, .weChatPay, .paynow, .promptPay, .mbWay, .bizum:
                        return []
                    case .ngCard, .ngBankTransfer, .momo, .gcash, .touchNGo, .trueMoney, .shopeePay, .ngWallet, .qris, .ngUSSD, .mondu, .goPay, .alipay, .EPS, .FPX, .grabPay, .netBanking, .payPal, .przelewy24, .klarna,
